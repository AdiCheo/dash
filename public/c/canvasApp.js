...
function intersects(rect1, rect2){
  ...
  var r1 = {
    left:   rect1.x,
    top:    rect1.y,
    right:  context.measureText(  rect1.word).width,
    bottom: context.measureText(  rect1.word).height
  };

  var r2 = {
    left:   rect2.x,
    top:    rect2.y,
    right:  context.measureText(  rect2.word).width,
    bottom: context.measureText(  rect2.word).height
  };

  console.log("check contatct");
...
function handleTimer(){
  ...
  // getWordAtLocation
  var left = movingString.x;
  var right = movingString.x + movingString.stringWidth;
  var midx = movingString.x + (movingString.stringWidth/2);
  var bottom = movingString.y;
  var top = movingString.y - movingString.stringHeight;
  if (getWordAtLocation(left, bottom) != null ||
      getWordAtLocation(right, bottom) != null ||
      getWordAtLocation(midx, top) != null ||
      getWordAtLocation(midx, bottom) != null ||
      getWordAtLocation(left, top) != null ||
      getWordAtLocation(right, top) != null) {
